...
from Original_worker_functions import *
...
if __name__ == '__main__' :
    ...
    save_path = 'thalamocortical_Oren/CreateThalamicInputs/Oren_original_with_tidying_ip/test_original'#directory to save the files in 
    ...
    def run_experiment(Standard, Deviant, BS, spike_replay_name):
        ...
        return experiment['frequencies']

    times = range(experiment['first_stimulus_time'], experiment['simulation_end_time'], experiment['duration_of_stim']) 
    stim_times = {}
    stim_order = run_experiment(6666, 9600, 106746, 'input6666_106746_3.dat')    
    stim_times[6666] = [[times[i], stim_order[i]] for i in range(len(stim_order))]
