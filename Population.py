...
class Population():
	...
	def loadTemplate(self):
		...
		morphology_loaded = h.load_file('morphology.hoc')
		biophysics_loaded = h.load_file('biophysics.hoc')
	...
	def addInput(self, cell, mode, n_axons, n_contacts_per_axon, frac_standard_axons = 0.5, filename=''):
		"""
